...
export function generateApplicationPack(
  ...
  return {
    ...
    hiringManagerDm: `Hi, I am interested in ${job.company}'s ${job.title} role. I have worked on lifecycle analytics, segmentation, campaign performance tracking, PRD/UAT coordination, and AI chatbot feasibility in regulated finance settings. My angle is helping product and growth teams make better decisions from customer and campaign data, especially where analytical rigor and cross-functional delivery matter.`,
